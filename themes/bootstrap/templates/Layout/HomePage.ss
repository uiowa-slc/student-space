        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                <div class="homepage-hero__intro text-center mt-5 mb-5">
                    ...
                    <p class="mt-5 mb-5"><a href="https://outlook.office.com/calendar/" target="_blank" class="homepage-hero__office btn br-0 btn-primary btn-lg">Open Office 365 Calendar <i class="fas fa-external-link-alt" aria-hidden="true"></i></a></p>
                </div>
